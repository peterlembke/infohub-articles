![What is infohub logo](../generic-image/pexels-eyüp-belen-1428626-sv.jpg)
...
Appen **Välkommen** ger dig en idé vad du kan göra med Infohub som användare och som utvecklare. **Demo** visar vad Infohub kan göra. **Verktyg** är mindre funktioner som kan vara användbara. Till exempel en lösenordsgenerator. 
...
Appen **Tillgångar** ger erkännande till skaparna av all grafik och ljud som används i Infohub. Varje tillgång har en licensfil och du kan se all information här.
...
Du behöver ett vanligt webbhotell. 
Infohub har testats på Apache 2 webbserver och PHP 8.0. 
Du behöver också någon typ av databas. 
Infohub stödjer just nu MySQL, MariaDB, SQLite, PostgreSQL.

Om du vet hur du installerar din egen server då kan du till och med köra Infohub på en Raspberry Pi 3.

## Vad behöver jag för att utveckla applikationer till Infohub?
Du behöver grundläggande programmeringskunskaper och vara bra på klipp och klistra. 
Din kod ser ungefär samma ut i PHP och Javascript och använder rena enkla kommandon. 
En del skulle kunna säga att det liknar BASIC.

Det finns en mall i Javascript och en mall i PHP för att du ska kunna komma igång. 
Du kan också kika på de existerande applikationerna och läsa dokumentationen.
